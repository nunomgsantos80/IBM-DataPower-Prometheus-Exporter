...
### How it works
- A secret key (`DP_KEY`) is stored as an environment variable. **Keep this key to avoid regenerating the entire process. In case of a reboot, you can reuse the same DP_KEY without changing the JSON file.**
